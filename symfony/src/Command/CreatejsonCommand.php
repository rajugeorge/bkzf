...
class CreatejsonCommand extends Command
{
    protected static $defaultName = 'app:createjson';
    protected static $defaultDescription = 'Create Study Json';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->createJsonService->createjson();

        $io = new SymfonyStyle($input, $output);

        $io->success('Successfully Json Created');
